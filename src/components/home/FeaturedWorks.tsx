...
const featuredLoupeBg = {
  ...heroLoupeSourceBackground,
...
const FeaturedWorks = () => {
  ...
  return (
    <MagnifierSection className="relative bg-[var(--bg-2)] py-32 md:py-44" data-spotlight>
      <div data-magnifier-stack className="relative">
        <div
          aria-hidden
          data-magnifier-source
          className="pointer-events-none absolute inset-0 -z-10"
          style={featuredLoupeBg}
        />
        <div className="shell">
          <div
          ...
          >
            ...
            <div className="col-span-12 md:col-span-6 md:col-start-7" data-magnifier-exclude>
