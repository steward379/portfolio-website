...
const isPublicProject = (p: Project) => !p.hidden;
  ...
  export const projects: Project[] = [
    ...
    },
    {
      ...
      fullDescription:
        '「零廢敬媽祖」是一場與<strong>大甲鎮瀾宮</strong>合作的宗教減廢倡議：在台灣最具規模的<strong>2026 大甲媽祖遶境</strong>現場，透過友善商家、清洗據點與循環／自備餐具等機制，讓減廢成為可被理解、參與並延續的日常選擇，並逐步累積成可複製的宗教永續經驗。<br/><br/>此為倡議底下<strong>獨立製作</strong>的 Mobile First 互動頁——使用者透過<strong>「清淨守護籤」</strong>取得個人化的祈福語與行動提示，將<span style="white-space:nowrap;">「少用一次性餐具」</span>等訊息包裝成可分享的結果卡，並可連結至現場集點與倡議脈絡；視覺延續主題的橙色祈福語境與 Q 版守護神意象。<br/><br/>倡議主資訊、計畫與回饋見<a href="/portfolio-website/portfolio/zero-waste-mazu-website">零廢敬媽祖：倡議官網</a>；線上官網：<a href="https://www.eco100.tw/zwmazu" target="_blank" rel="noopener noreferrer">https://www.eco100.tw/zwmazu</a>。群眾募資背景見 <a href="https://www.zeczec.com/projects/zwmazu" target="_blank" rel="noopener noreferrer">嘖嘖專案頁</a>。<br/><br/><small>企劃／文案支援、網站前端、互動：Steward (創辦人)<br/>部署、網站前端支援：Timothy<br/>設計、企劃：FUTUAL 共生未來團隊<br/><br/>倡議企畫：永續百行<br/>宮廟合作：大甲鎮瀾宮<br/>計畫說明見嘖嘖專案頁：<a href="https://www.zeczec.com/projects/zwmazu" target="_blank" rel="noopener noreferrer">https://www.zeczec.com/projects/zwmazu</a></small>',
      category: 'website',
      industries: ['environment', 'religion'],
