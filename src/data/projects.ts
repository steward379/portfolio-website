export interface Project {
  ...
  export const projects: Project[] = [
    ...
    {
      id: 'tech-company-website',
      title: '科技公司企業網站',
      client: '創新科技有限公司',
      description: '為領先的科技公司設計的現代企業網站，突顯產品與服務。',
      fullDescription: '為快速成長的科技公司重新設計並開發的企業網站。網站使用 Next.js 構建，具有引人入勝的動畫效果和互動元素。網站結構經過精心設計，以最佳方式展示公司的產品、服務和公司文化。此外，我們還實現了多語言支持和內容管理系統，使客戶能夠輕鬆更新網站內容。',
      category: 'website',
      industry: 'technology',
      image: '/images/projects/tech-1.jpg',
      images: [
        '/images/projects/tech-1.jpg',
        '/images/projects/tech-2.jpg',
        '/images/projects/tech-3.jpg',
      ],
      featured: false,
      date: '2024-11',
      url: 'https://example.com/tech-company',
    },
    {
